...
const Styling = styled.div`
    ...
    & .parallax {
        ...
        transform: translateX(calc(10px * var(--parallax-x) * var(--depth)))
            translateY(calc(10px * var(--parallax-y) * var(--depth)));
    }
...
const ParallaxLayer = ({ depth, children, mix }: { depth: number; mix?: number; children: ReactNode }) => (
    <g
...
export const DemoParallaxHills = () => {
