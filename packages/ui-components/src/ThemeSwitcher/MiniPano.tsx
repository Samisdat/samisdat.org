      ...
      <MiniPanoSvg width="100%" height="100%" viewBox="0 0 179 59">
        <g id="heaven">
          ...
          <g id="celestialBodies">
            ...
            <path
              id="moon"
              d="M149.998,6.616c12.074,0.392 21.757,10.318 21.757,22.487c0,12.419 -10.082,22.5 -22.5,22.5c-8.326,0 -15.602,-4.532 -19.493,-11.262c0.247,0.008 0.495,0.012 0.743,0.012c12.418,0 22.5,-10.081 22.5,-22.5c0,-4.091 -1.094,-7.929 -3.007,-11.237Z"
              style={{ fill: "#ededed" }}
            />
          </g>
          <g id="tower">
