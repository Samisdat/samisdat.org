...
const preview: Preview = {
    decorators: [
        ...
        Story => {
            ...
            if (root) {
                root.style.setProperty('--font-serif', "'Source Serif 4 Variable', serif");
                root.style.setProperty('--font-sans', "'Source Sans 3 Variable', sans-serif");
                root.style.setProperty('--font-code', "'Source Code Pro Variable', monospace");
